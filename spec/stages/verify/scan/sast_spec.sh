Describe "security/sast.sh"
  ...
  Include "$BRIK_HOME/lib/stages/verify/scan/sast.sh"
  Include "$BRIK_HOME/spec/support/mock_helper.sh"

  Describe "verify.scan.sast.run"
    It "returns 6 for nonexistent workspace"
      When call verify.scan.sast.run "/nonexistent/workspace"
    ...
    Describe "Tier 1: command override"
      ...
      It "runs command override"
        When call verify.scan.sast.run "$TEST_WS"
