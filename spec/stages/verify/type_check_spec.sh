Describe "quality/type_check.sh"
  ...
  Include "$BRIK_HOME/lib/stages/verify/type_check.sh"
  Include "$BRIK_HOME/spec/support/mock_helper.sh"

  Describe "verify.type_check.run"
    It "returns 6 for nonexistent workspace"
      When call verify.type_check.run "/nonexistent/workspace"
    ...
    Describe "unknown option"
      ...
      It "returns 2 for unknown option"
        When call verify.type_check.run "$TEST_WS" --badopt
    ...
    Describe "Tier 1: command override success"
      ...
      It "runs command override and passes"
        When call verify.type_check.run "$TEST_WS"
    ...
    Describe "Tier 2: tsc with npx"
      ...
      It "runs npx tsc --noEmit"
        invoke_tsc() {
          verify.type_check.run "$TEST_WS" 2>/dev/null || return 1
