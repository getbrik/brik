Describe "stages.notify - CI mode fragment aggregation"
  ...
  Describe "CI mode (fragments present)"
    ...
    # (The Unicode recap table previously emitted on stderr was removed
    # in favor of folding Business + Metrics columns into the markdown
    # Stages table -- see _report._render_aggregate_md. Per-stage
    # ordering is covered by spec/pipeline/report_aggregate_business_spec.sh.)
  End
