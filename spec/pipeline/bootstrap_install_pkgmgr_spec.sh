Describe "bootstrap.sh - package manager installers and python post-install"
  Include "$BRIK_PIPELINE_LIB/bootstrap.sh"
  Include "$BRIK_HOME/spec/support/mock_helper.sh"


  # ---------------------------------------------------------------------------
  # _bootstrap._install_via_apk (direct tests)
  # ---------------------------------------------------------------------------
  Describe "_bootstrap._install_via_apk"
    Describe "installs node packages"
      ...
      It "maps node to nodejs npm"
        When call _bootstrap._install_via_apk "node"
    ...
    Describe "installs java with version"
      ...
      It "uses version in package name"
        When call _bootstrap._install_via_apk "java" "17"
        The status should be success
    ...
    Describe "installs java without version (defaults to 21)"
      ...
      It "defaults to openjdk21-jdk"
        When call _bootstrap._install_via_apk "java" ""
        The status should be success
    ...
    Describe "installs dotnet with version"
      ...
      After 'mock.cleanup'
      It "uses version in package name"
        When call _bootstrap._install_via_apk "dotnet" "9"
        The status should be success
    ...
    Describe "handles apk failure"
      ...
      It "returns 5 on failure"
        When call _bootstrap._install_via_apk "python"
  ...
  # ---------------------------------------------------------------------------
  # _bootstrap._install_via_apt (direct tests)
  # ---------------------------------------------------------------------------
  Describe "_bootstrap._install_via_apt"
    Describe "installs python packages"
      ...
      It "maps python to python3 python3-pip python3-setuptools"
        When call _bootstrap._install_via_apt "python"
        The status should be success
    ...
    Describe "installs java with version"
      ...
      After 'mock.cleanup'
      It "uses version in package name"
        When call _bootstrap._install_via_apt "java" "17"
        The status should be success
    ...
    Describe "handles apt-get failure"
      ...
      After 'mock.cleanup'
      It "returns 5 on failure"
        When call _bootstrap._install_via_apt "jq"
        The status should equal 5
  ...
  # ---------------------------------------------------------------------------
  # _bootstrap._install_via_yum (direct tests)
  # ---------------------------------------------------------------------------
  Describe "_bootstrap._install_via_yum"
    Describe "installs rust packages"
      ...
      It "maps rust to rust cargo"
        When call _bootstrap._install_via_yum "rust"
        The status should be success
    ...
    Describe "handles yum failure"
      ...
      After 'mock.cleanup'
      It "returns 5 on failure"
        When call _bootstrap._install_via_yum "git"
        The status should equal 5
  ...
  # ---------------------------------------------------------------------------
  # _bootstrap._install_via_dnf (direct tests)
  # ---------------------------------------------------------------------------
  Describe "_bootstrap._install_via_dnf"
    Describe "installs dotnet with default version"
      ...
      It "defaults to dotnet-sdk-8.0"
        When call _bootstrap._install_via_dnf "dotnet" ""
        The status should be success
    ...
    Describe "handles dnf failure"
      ...
      After 'mock.cleanup'
      It "returns 5 on failure"
        When call _bootstrap._install_via_dnf "bash"
        The status should equal 5
  ...
  # ---------------------------------------------------------------------------
  # _bootstrap._install_via_mise (edge cases)
  # ---------------------------------------------------------------------------
  Describe "_bootstrap._install_via_mise"
    Describe "with unknown tool name"
      ...
      It "warns and tries as-is"
        When call _bootstrap._install_via_mise "elixir" "1.16"
        The status should be success
    ...
    Describe "when mise install fails"
      ...
      After 'mock.cleanup'
      It "returns 5"
        When call _bootstrap._install_via_mise "node" "20"
        The status should equal 5
  ...
  # ---------------------------------------------------------------------------
  # _bootstrap._python_post_install (CI paths)
  # ---------------------------------------------------------------------------
  Describe "_bootstrap._python_post_install on CI"
    Describe "with python3 but no EXTERNALLY-MANAGED marker"
      ...
      It "succeeds without marker to remove"
        When call _bootstrap._python_post_install
        The status should be success
      End
    End
    ...
    Describe "with EXTERNALLY-MANAGED marker present"
      ...
      It "removes the marker file"
        check_marker_removed() {
          _bootstrap._python_post_install 2>/dev/null
