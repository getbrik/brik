Describe "bootstrap.sh - install_yq / install_prerequisites / URL helpers / self_host_binary"
  ...
  Describe "bootstrap.install_yq"
    Describe "when yq is already present"
      ...
      It "returns 0 immediately"
        When call bootstrap.install_yq
  ...
  # ---------------------------------------------------------------------------
  Describe "bootstrap.install_prerequisites"
  ...
  # _bootstrap._yq_url
  # ---------------------------------------------------------------------------
  Describe "_bootstrap._yq_url"
    It "contains yq version in URL"
      When call _bootstrap._yq_url
  ...
  # _bootstrap._jq_url
  # ---------------------------------------------------------------------------
  Describe "_bootstrap._jq_url"
    It "contains jq version in URL"
      When call _bootstrap._jq_url
  ...
  # ---------------------------------------------------------------------------
  Describe "_bootstrap._self_host_binary"
    Describe "succeeds with wget"
      ...
      It "downloads to BRIK_HOME/bin"
        When call _bootstrap._self_host_binary "mytool" "https://example.com/mytool"
        The status should be success
