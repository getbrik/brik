Describe "bootstrap.sh - install_stack / check_stack / prepare_env"
  ...
  # ---------------------------------------------------------------------------
  Describe "bootstrap.install_stack"
    Describe "with empty stack name"
      It "returns 2"
        When call bootstrap.install_stack ""
    ...
    Describe "on CI with apk for java with version"
      ...
      It "installs with version"
        When call bootstrap.install_stack "java"
        The status should be success
    ...
    Describe "on CI with apk for python"
      ...
      After 'mock.cleanup'
      It "installs python"
        When call bootstrap.install_stack "python"
        The status should be success
    ...
    Describe "on CI with apk for dotnet"
      ...
      It "installs dotnet"
        When call bootstrap.install_stack "dotnet"
        The status should be success
  ...
  # ---------------------------------------------------------------------------
  Describe "bootstrap.check_stack"
    Describe "when tool is present"
      ...
      After 'mock.cleanup'
      It "returns 0 for node"
        When call bootstrap.check_stack "node"
        The status should be success
  ...
  # ---------------------------------------------------------------------------
  Describe "_bootstrap._python_post_install"
