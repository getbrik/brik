...
stack in 4 steps", read [`docs/operations/extensions.md`](../../how-to/use-extensions.md)
...
| [`runner-classes.md`](../../concepts/runner-classes.md) | Platform / extension author | The runner-class -> image registry (`runner_classes.yml`), the dotenv contract, and the `BRIK_RUNNER_CLASSES_FILE` override. |
