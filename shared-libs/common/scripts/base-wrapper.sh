...
#
# Platform-specific pre-stage hooks (e.g. GitLab's .brik-keep marker pre-
# creation in _brik_gitlab._ensure_artefact_markers) live in the
# corresponding shared-libs/<platform>/ wrapper. base-wrapper stays
# platform-agnostic.
#
